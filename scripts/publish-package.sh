...
#
# `dist/` is gitignored and neither package has a `prepare` hook, so a fresh
...
# ---------------------------------------------------------------------------
# 4. Dependency order. `rules` pins `engine` exactly, so publishing rules first
#    yields a package that installs and then immediately fails to resolve.
# ---------------------------------------------------------------------------
